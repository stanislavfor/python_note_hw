...
Дается после блока программирования и курсов "Знакомство с языком программирования Python" и 
"Java: знакомство и как ользоваться базовыми API".

## Информация о работе

Включает в себя два задания: "Приложение заметки" – **Урок 1**, которое выполняется на ЯП Python и 
